...
import {getStatResponses, getStatResponsesBySubjectId} from '../index'

describe(testContext(__filename), function () {
  withDBCleanup()
  useFixture.buildSurvey()

  it('returns the response information for the stat questions for the given survey', async function () {
    ...
    const questionRefs = stats.map((stat, i) => ({subjectIds: [subjectId], questionId: questions[i].id, statId: stat.id}))
    ...
    const result = await getStatResponses({surveyId: this.survey.id})
