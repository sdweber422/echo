...
describe(testContext(__filename), function () {
  ...
  beforeEach(async function () {
    ...
    this.createLvl1Players = count => _createPlayers({count, chapterId, elo: 900, experiencePoints: 0, cultureContribution: 65, teamPlay: 65, technicalHealth: 0})
    this.createLvl2Players = count => _createPlayers({count, chapterId, elo: 990, experiencePoints: 150, cultureContribution: 80, teamPlay: 80, technicalHealth: 0})
    this.createLvl4Players = count => _createPlayers({count, chapterId, elo: 1100, experiencePoints: 750, cultureContribution: 90, teamPlay: 90, technicalHealth: 90})
  })
