...
describe(testContext(__filename), function () {
  ...
  it('works when user not logged in')
  it('works when user not authorized')
  it('works when no cycle is in GOAL_SELECTION')
  it('works when multiple cycles are in GOAL_SELECTION')
  it('works when goal url is not valid for this chapter')
})
