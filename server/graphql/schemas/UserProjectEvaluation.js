...
export default new GraphQLObjectType({
  ...
  fields: () => {
    ...
    return {
      ...
      [STAT_DESCRIPTORS.TEAM_PLAY_FRICTION_REDUCTION]: {type: GraphQLFloat, description: 'The friction reduction rating'},
      [STAT_DESCRIPTORS.TEAM_PLAY_FLEXIBLE_LEADERSHIP]: {type: GraphQLFloat, description: 'The flexible leadership rating'},
      [STAT_DESCRIPTORS.GENERAL_FEEDBACK]: {type: GraphQLString, description: 'General text feedback'},
      [STAT_DESCRIPTORS.TEAM_PLAY_RECEPTIVENESS]: {type: GraphQLString, description: 'The teamPlayReceptiveness rating'},
      [STAT_DESCRIPTORS.RELATIVE_CONTRIBUTION]: {type: GraphQLFloat, description: 'The relative contribution rating'},
      [STAT_DESCRIPTORS.TEAM_PLAY_RESULTS_FOCUS]: {type: GraphQLFloat, description: 'The results focus rating'},
