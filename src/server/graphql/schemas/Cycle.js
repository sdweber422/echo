...
import {resolveChapter, resolveWeekStartedAt} from 'src/server/graphql/resolvers'
...
export default new GraphQLObjectType({
  ...
  fields: () => {
    ...
    return {
      ...
      weekStartedAt: {type: new GraphQLNonNull(GraphQLDateTime), description: 'The first day of the cycle week', resolve: resolveWeekStartedAt},
    }
  },
})
